...
<div id="container">
 <div class="header">
   <div class="logo">
     <img class="logo-img" src="{{ $student->img ? asset('storage/' . $student->img) : asset('/images/logo.png') }}"
     >
   </div>

 </div>
 <section class="left-section">
     <img src="{{ $student->img ? asset('storage/' . $student->img) : asset('/images/logo.png') }}"
     class="profile-pic">
   <div class="profile-detail">
     ...
     <span class="profile-summary">{{ $student->email }}</span>
     <a class="profile-cv" href="#">{{ $student->phone }}</a>
 </div>
